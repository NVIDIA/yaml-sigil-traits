...
Run `cargo xtask ci` to check Markdown, formatting, package contents, Clippy,
tests, and dependencies in both the crate and standalone xtask workspace.
The GitHub Actions workflows run these checks as independent steps.
